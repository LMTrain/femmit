...
export default class Strapi {
     ...
     */
    getEntries(contentType: string, params?: AxiosRequestConfig['params']): Promise<object[]>;
    /**
     * Get a specific entry
     * @param contentType Type of entry
     * @param id ID of entry
     */
    getEntry(contentType: string, id: string): Promise<object>;
    /**
     * Create data
     * @param contentType Type of entry
     * @param data New entry
     */
    createEntry(contentType: string, data: AxiosRequestConfig['data']): Promise<object>;
    /**
     * Update data
     * @param contentType Type of entry
     * @param id ID of entry
     * @param data
     */
    updateEntry(contentType: string, id: string, data: AxiosRequestConfig['data']): Promise<object>;
    /**
     * Delete an entry
     * @param contentType Type of entry
     * @param id ID of entry
     */
    deleteEntry(contentType: string, id: string): Promise<object>;
    /**
     * Search for files
